...
const QUICK_START_PROMPTS_SEARCH = [
  "Analyze this Power Purchase Agreement (PPA) and generate a report on non-standard risk clauses.",
  "Extract all key dates, financial figures, and payment obligations from this contract into a table.",
  "Provide an overview of the regulatory framework for offshore wind energy projects in Spain.",
  "Summarize the key differences between Production Sharing Agreements (PSAs) and Concession Agreements.",
  ...
  "Check this services agreement for compliance with standard data protection regulations like GDPR.",
  "Outline the key legal components and common pitfalls of a standard Power Purchase Agreement (PPA).",
  "Analyze the 'Force Majeure' clause in this document to determine if it covers pandemics and cyber-attacks.",
  "What are the main legal challenges for cross-border electricity transmission projects in South America"
];

const QUICK_START_PROMPTS = [
  "Draft a standard Mutual Non-Disclosure Agreement (NDA) suitable for an oil & gas joint venture.",
  "Write a 'Force Majeure' clause that specifically includes pandemics and cyberattacks, governed by New York law.",
  "Create a 'Change of Law' clause that fairly balances risk between a public utility and a project developer.",
  "Draft an email to a counterparty proposing amendments to the 'Indemnity' section of an agreement.",
  ...
  "Create a boilerplate 'Governing Law and Jurisdiction' clause for a contract based in Colombia.",
  "Draft a formal notice of contract breach based on a failure to meet a payment deadline.",
  "Write a 'Confidentiality' clause that survives the termination of the agreement for 5 years."
];
      ...
      <div className="flex items-center justify-center mt-16 w-full">
        <div className="text-center max-w-3xl w-full">
          <Avatar className="mx-auto h-20 w-20">
            <AvatarImage src="/ClauseOS_AVATAR.png" alt="ClauseOS Logo" />
